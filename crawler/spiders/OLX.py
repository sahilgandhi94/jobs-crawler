...
class OLX(scrapy.Spider):
        ...
        for i in range(0, 100):
            ...
            if len(href) > 0 and len(date) > 0:
                ...
                if date.lower() == 'yesterday':
                    ...
                    yield req
                # else:
                    # print("Skipping because date: :{}:".format(date))
    ...
    def parse_job_details(self, response):
        ...
        # salary_type = ".//*[@id='offerdescription']/div[2]/table/tbody/tr[1]/td[2]/div/strong/a"
        # position = ".//*[@id='offerdescription']/div[2]/table/tbody/tr[1]/td[1]/div/strong/a"
